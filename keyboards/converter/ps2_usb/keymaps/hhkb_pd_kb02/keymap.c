...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------| ,-----------. |---------------|
     * |Ctl|MHEN|Alt|Gui|     Space      |Gui|KANA|Alt|HENK|App|Ctl| |Lef|Dow|Rig| |  #|  0|  .|KP=|
     * `-----------------------------------------------------------' `-----------' `---------------'
     * Swap MHEN with LGUI.
     * Swap HENK with GGUI.
     */
    ...
    KC_LCTL, KC_MHEN, KC_LALT, KC_LGUI,                   KC_SPC,                    KC_RGUI, KC_KANA, KC_RALT, KC_HENK, KC_APP,  KC_RCTL,    KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,   KC_PWR,  KC_PDOT, KC_PEQL,
